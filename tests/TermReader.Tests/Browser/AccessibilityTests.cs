...
// =============================================================================
//
// This file documents the current accessibility state of TermReader's 4 themes.
...
// ---------------------------------------------------------------------------
//
// All TermReader animations are terminal-safe for motion sensitivity:
...
public class AccessibilityTests
{
    ...
    public void DisableAnimations_ConfigOption_Exists()
    {
        ...
        var configType = typeof(TermReader.Infrastructure.Configuration.BrowserConfiguration);
        ...
        var instance = new TermReader.Infrastructure.Configuration.BrowserConfiguration();
