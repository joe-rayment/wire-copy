...
using TermReader.Infrastructure.Health;
using TermReader.Infrastructure.Http;
using TermReader.Infrastructure.Parsing;
...
namespace TermReader.Infrastructure;
...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.Configure<AuthConfiguration>(options =>
            configuration.GetSection(AuthConfiguration.SectionName).Bind(options));
        ...
        services.AddOptions<AuthConfiguration>().ValidateOnStart();
        ...
        var connectionString = configuration.GetConnectionString("DefaultConnection")
            ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "TermReader", "termreader.db");
