// <copyright file="RssFeedGenerator.cs" company="NYT Audio Scraper">
...
namespace NYTAudioScraper.Infrastructure.Podcast;
...
public class RssFeedGenerator : IRssFeedGenerator
{
    ...
    public string GenerateFeed(IEnumerable<PodcastEpisode> episodes, PodcastInfo podcastInfo)
    {
        ...
        writer.WriteElementString("generator", "NYT Audio Scraper");
