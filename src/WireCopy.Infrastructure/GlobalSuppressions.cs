// <copyright file="GlobalSuppressions.cs" company="Wire Copy">
...
// ============================================================================
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Result types are intentionally kept with their service class", Scope = "type", Target = "~T:WireCopy.Infrastructure.Browser.CookieImportResult")]
[assembly: SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:File may only contain a single type", Justification = "Result types are intentionally kept with their service class", Scope = "type", Target = "~T:WireCopy.Infrastructure.Browser.CookieInfoResult")]
