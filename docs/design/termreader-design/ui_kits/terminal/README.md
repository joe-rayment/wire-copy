# TermReader UI Kit — Terminal

Pixel-faithful recreation of the TermReader TUI as React/JSX components rendered inside a web `terminal frame`. Phosphor theme only.
